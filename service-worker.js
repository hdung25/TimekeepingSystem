...
const CACHE_NAME = 'tdt-chamcong-v115-huy-schedule-truth-20260809';
...
const STATIC_ASSETS = [
    ...
    '/js/report.js?v=20260809-huy-schedule-truth-v1',
    '/js/evaluation-service.js?v=20260809-huy-schedule-truth-v1',
