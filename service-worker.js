...
const CACHE_NAME = 'tdt-chamcong-v81-meeting-rsvp';
...
const STATIC_ASSETS = [
    ...
    '/js/main.js?v=20260721-meeting-rsvp-v1',
    '/js/firebase-config.js',
    '/js/db-service.js?v=20260721-meeting-rsvp-v1',
    ...
    '/js/ui-service.js',
    '/js/auth-guard.js?v=20260721-meeting-rsvp-v1',
    '/js/chart-service.js',
    '/js/analytics.js',
