...
const CACHE_NAME = 'tdt-chamcong-v88-hour-cap';
...
const STATIC_ASSETS = [
    ...
    '/js/main.js?v=20260725-hour-cap-v1',
    '/js/firebase-config.js',
    '/js/db-service.js?v=20260725-hour-cap-v1',
    '/js/report.js?v=20260717-gv-absence-v1',
    '/js/evaluation-service.js?v=20260725-hour-cap-v1',
    '/js/shift-oversight.js?v=20260717-gv-absence-v1',
    '/js/ui-service.js',
    '/js/auth-guard.js?v=20260725-hour-cap-v1',
    '/js/chart-service.js',
    '/js/analytics.js',
