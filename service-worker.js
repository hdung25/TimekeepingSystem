...
const CACHE_NAME = 'tdt-chamcong-v79-meetings';
...
const STATIC_ASSETS = [
    ...
    '/js/main.js?v=20260719-meetings-v4',
    '/js/firebase-config.js',
    '/js/db-service.js?v=20260719-meetings-v4',
    ...
    '/js/ui-service.js',
    '/js/auth-guard.js?v=20260719-meetings-v4',
    '/js/chart-service.js',
    '/js/analytics.js',
