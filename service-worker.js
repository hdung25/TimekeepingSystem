...
const CACHE_NAME = 'tdt-chamcong-v123-schedule-boundary-20260809';
...
const STATIC_ASSETS = [
    ...
    '/js/report.js?v=20260809-schedule-boundary-v6',
    '/js/evaluation-service.js?v=20260809-schedule-boundary-v6',
