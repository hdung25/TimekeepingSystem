...
const CACHE_NAME = 'tdt-chamcong-v78-meetings';
...
const STATIC_ASSETS = [
    ...
    '/js/main.js?v=20260719-meetings-v3',
    '/js/firebase-config.js',
    '/js/db-service.js?v=20260719-meetings-v3',
    ...
    '/js/ui-service.js',
    '/js/auth-guard.js?v=20260719-meetings-v3',
    '/js/chart-service.js',
    '/js/analytics.js',
