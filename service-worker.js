...
const CACHE_NAME = 'tdt-chamcong-v76-makeup-cal';
...
const STATIC_ASSETS = [
    ...
    '/js/main.js?v=20260719-makeup-cal-v1',
    '/js/firebase-config.js',
    '/js/db-service.js?v=20260719-makeup-cal-v1',
    ...
    '/js/ui-service.js',
    '/js/auth-guard.js?v=20260719-makeup-cal-v1',
    '/js/chart-service.js',
    '/js/analytics.js',
