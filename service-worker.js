...
const CACHE_NAME = 'tdt-chamcong-v86-meeting-card';
...
const STATIC_ASSETS = [
    ...
    '/js/main.js?v=20260722-meeting-card-v2',
    '/js/firebase-config.js',
    '/js/db-service.js?v=20260722-meeting-card-v2',
    ...
    '/js/ui-service.js',
    '/js/auth-guard.js?v=20260722-meeting-card-v2',
    '/js/chart-service.js',
    '/js/analytics.js',
