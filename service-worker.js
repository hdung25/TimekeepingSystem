...
const CACHE_NAME = 'tdt-chamcong-v89-hour-cap2';
...
const STATIC_ASSETS = [
    ...
    '/js/main.js?v=20260725-hour-cap-v2',
    '/js/firebase-config.js',
    '/js/db-service.js?v=20260725-hour-cap-v2',
    '/js/report.js?v=20260717-gv-absence-v1',
    '/js/evaluation-service.js?v=20260725-hour-cap-v2',
    '/js/shift-oversight.js?v=20260717-gv-absence-v1',
    '/js/ui-service.js',
    '/js/auth-guard.js?v=20260725-hour-cap-v2',
    '/js/chart-service.js',
    '/js/analytics.js',
