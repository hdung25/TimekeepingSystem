...
const CACHE_NAME = 'tdt-chamcong-v120-huy-session-split-20260809';
...
const STATIC_ASSETS = [
    ...
    '/js/report.js?v=20260809-huy-session-split-v3',
    '/js/evaluation-service.js?v=20260809-huy-session-split-v3',
