// Service Worker v76 - reversible absence and pending teacher replacement flow.
const CACHE_NAME = 'tdt-chamcong-v133-absence-recovery-20260819';
...
const STATIC_ASSETS = [
    ...
    '/js/main.js?v=20260816-early10-old-unset-v3',
    '/js/firebase-config.js',
    '/js/db-service.js?v=20260819-absence-recovery-v1',
    '/js/report.js?v=20260819-absence-recovery-v1',
    '/js/evaluation-service.js?v=20260819-absence-recovery-v1',
    ...
    '/js/personnel.js?v=20260814-senior-receptionist-v1',
    ...
    '/js/receptionist-schedule.js?v=20260819-absence-recovery-v1',
