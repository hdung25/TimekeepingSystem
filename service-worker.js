...
const CACHE_NAME = 'tdt-chamcong-v114-cross-role-schedule-recovery-20260809';
...
const STATIC_ASSETS = [
    ...
    '/js/report.js?v=20260809-cross-role-schedule-recovery-v1',
    '/js/evaluation-service.js?v=20260809-cross-role-schedule-recovery-v1',
