...
const CACHE_NAME = 'tdt-chamcong-v55-fix-recep-proportional-hours-and-lateness';
...
const STATIC_ASSETS = [
    ...
    '/js/main.js?v=20260709-fix-recep-proportional-hours-and-lateness',
    '/js/firebase-config.js',
    '/js/db-service.js?v=20260704-timezone-fix',
    '/js/report.js?v=20260709-fix-recep-proportional-hours-and-lateness',
    '/js/evaluation-service.js?v=20260709-fix-recep-proportional-hours-and-lateness',
    '/js/ui-service.js',
