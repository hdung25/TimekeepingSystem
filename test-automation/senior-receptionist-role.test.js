...
assert.match(worker, /tdt-chamcong-v177-subject-refresh-meeting-auto-20260911/,
    'Service worker cache must be bumped');
assert.match(read('bao-cao.html'), /report\.js\?v=20260911-subject-refresh-meeting-auto-v1/,
