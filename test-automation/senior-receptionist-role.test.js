...
assert.match(worker, /tdt-chamcong-v175-revoke-makeup-meeting-sync-20260911/,
    'Service worker cache must be bumped');
assert.match(read('bao-cao.html'), /report\.js\?v=20260911-revoke-makeup-meeting-sync-v1/,
