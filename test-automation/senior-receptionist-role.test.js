...
assert.match(worker, /tdt-chamcong-v143-schedule-attendance-admin-20260901/,
    'Service worker cache must be bumped');
assert.match(read('bao-cao.html'), /report\.js\?v=20260901-schedule-admin-attendance-v2/,
