...
assert.match(worker, /tdt-chamcong-v169-payroll-rate-persistence-20260910/,
    'Service worker cache must be bumped');
assert.match(read('bao-cao.html'), /report\.js\?v=20260910-payroll-rate-persistence-v1/,
