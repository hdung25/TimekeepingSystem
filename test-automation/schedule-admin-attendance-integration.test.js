...
const dbIndex = html.indexOf('js/db-service.js?v=20260918-payslip-status-sync-v1');
const scheduleIndex = html.indexOf('js/schedule.js?v=20260916-transfer-end-date-v1');
