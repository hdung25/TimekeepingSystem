...
const version = '20260905-payroll-schedule-integrity-v2';
...
assert.match(worker, /tdt-chamcong-v152-payroll-schedule-integrity-20260905/);
assert.match(worker, /startup-recovery\.js\?v=20260905-payroll-schedule-integrity-v2/,
