...
const version = '20260905-attendance-integrity-v1';
...
assert.match(worker, /tdt-chamcong-v151-attendance-integrity-20260905/);
assert.match(worker, /startup-recovery\.js\?v=20260905-attendance-integrity-v1/,
