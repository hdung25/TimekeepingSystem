...
const version = '20260904-attendance-auth-recovery-v1';
...
assert.match(worker, /tdt-chamcong-v150-attendance-auth-recovery-20260904/);
assert.match(worker, /startup-recovery\.js\?v=20260904-attendance-auth-recovery-v1/,
