...
const version = '20260904-admin-payroll-override-v1';
...
assert.match(worker, /tdt-chamcong-v149-admin-payroll-override-20260904/);
assert.match(worker, /startup-recovery\.js\?v=20260904-admin-payroll-override-v1/,
