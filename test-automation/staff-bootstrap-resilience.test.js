...
const version = '20260904-transfer-source-coverage-v1';
...
assert.match(worker, /tdt-chamcong-v148-transfer-source-coverage-20260904/);
assert.match(worker, /startup-recovery\.js\?v=20260904-transfer-source-coverage-v1/,
