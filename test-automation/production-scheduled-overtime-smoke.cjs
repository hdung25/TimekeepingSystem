...
const version = '20260909-scheduled-overtime-v1';
...
(async () => {
    ...
    try {
        ...
        await page.waitForFunction(async () => {
            ...
            const key = (await caches.keys()).find(name => name.includes('v165-scheduled-overtime'));
        ...
        evidence.browser = await page.evaluate(async () => ({
            ...
            cachedAssets: (await (await caches.open('tdt-chamcong-v165-scheduled-overtime-20260909')).keys()).length
        }));
