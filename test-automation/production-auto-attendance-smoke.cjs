...
(async () => {
    ...
    try {
        ...
        await page.waitForFunction(async () => {
            ...
            const key = (await caches.keys()).find(name => name === 'tdt-chamcong-v171-admin-override-default-20260910');
        ...
        evidence.browser = await page.evaluate(async () => ({
            ...
            cachedAssets: (await (await caches.open('tdt-chamcong-v171-admin-override-default-20260910')).keys()).length
        }));
