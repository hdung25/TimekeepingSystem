...
assert.match(baoCao, /db-service\.js\?v=20260912-denial-timing-v1/);
...
assert.match(serviceWorker, /tdt-chamcong-v186-autoclose-subject-20260914/);
...
assert.match(chamCong, /db-service\.js\?v=20260912-denial-timing-v1/);
assert.match(chamCong, /main\.js\?v=20260912-denial-timing-v1/);
assert.match(chamCong, /timekeeping\.js\?v=20260912-denial-timing-v1/);
assert.match(serviceWorker, /db-service\.js\?v=20260912-denial-timing-v1/);
assert.match(serviceWorker, /timekeeping\.js\?v=20260912-denial-timing-v1/);
