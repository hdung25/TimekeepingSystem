...
assert.match(baoCao, /style\.css\?v=20260925-landscape-v1/);
...
assert.match(serviceWorker, /tdt-chamcong-v205-landscape-20260925/);
...
assert.match(chamCong, /main\.js\?v=20260925-landscape-v1/);
