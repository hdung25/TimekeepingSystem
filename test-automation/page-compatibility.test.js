...
assert.match(baoCao, /db-service\.js\?v=20260912-attendance-month-index-v1/);
...
assert.match(serviceWorker, /tdt-chamcong-v182-attendance-month-index-20260912/);
...
assert.match(chamCong, /db-service\.js\?v=20260912-attendance-month-index-v1/);
assert.match(chamCong, /main\.js\?v=20260912-fast-startup-v1/);
assert.match(chamCong, /timekeeping\.js\?v=20260912-fast-startup-v1/);
assert.match(serviceWorker, /db-service\.js\?v=20260912-attendance-month-index-v1/);
assert.match(serviceWorker, /timekeeping\.js\?v=20260912-fast-startup-v1/);
