...
assert.match(baoCao, /db-service\.js\?v=20260908-feedback-repair-v1/);
assert.match(baoCao, /report\.js\?v=20260909-consultation-payroll-v1/);
...
assert.match(serviceWorker, /tdt-chamcong-v162-consultation-payroll-20260909/);
assert.match(serviceWorker, /subject-rate-policy\.js\?v=20260809-subject-rate-v1/);
assert.match(serviceWorker, /report\.js\?v=20260909-consultation-payroll-v1/);
assert.match(serviceWorker, /lich-van-phong\.html/);
assert.match(chamCong, /db-service\.js\?v=20260908-feedback-repair-v1/);
...
assert.match(serviceWorker, /db-service\.js\?v=20260908-feedback-repair-v1/);
