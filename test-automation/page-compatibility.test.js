...
assert.match(baoCao, /report\.js\?v=20260911-revoke-makeup-meeting-sync-v1/);
...
assert.match(serviceWorker, /tdt-chamcong-v176-auto-checkout-resume-20260911/);
assert.match(serviceWorker, /subject-rate-policy\.js\?v=20260809-subject-rate-v1/);
assert.match(serviceWorker, /report\.js\?v=20260911-revoke-makeup-meeting-sync-v1/);
