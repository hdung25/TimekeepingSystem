...
assert.match(baoCao, /db-service\.js\?v=20260912-payroll-recall-rates-v1/);
assert.match(baoCao, /report\.js\?v=20260912-payroll-recall-rates-v1/);
...
assert.match(serviceWorker, /tdt-chamcong-v180-payroll-recall-20260912/);
assert.match(serviceWorker, /subject-rate-policy\.js\?v=20260809-subject-rate-v1/);
assert.match(serviceWorker, /report\.js\?v=20260912-payroll-recall-rates-v1/);
assert.match(serviceWorker, /lich-van-phong\.html/);
assert.match(chamCong, /db-service\.js\?v=20260912-payroll-recall-rates-v1/);
assert.match(chamCong, /main\.js\?v=20260911-position-allowance-v1/);
assert.match(chamCong, /timekeeping\.js\?v=20260911-auto-checkout-resume-v1/);
assert.match(serviceWorker, /db-service\.js\?v=20260912-payroll-recall-rates-v1/);
