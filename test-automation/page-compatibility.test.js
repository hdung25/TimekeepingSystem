...
assert.match(baoCao, /report\.js\?v=20260909-auto-attendance-v2/);
...
assert.match(serviceWorker, /tdt-chamcong-v166-auto-attendance-20260909/);
assert.match(serviceWorker, /subject-rate-policy\.js\?v=20260809-subject-rate-v1/);
assert.match(serviceWorker, /report\.js\?v=20260909-auto-attendance-v2/);
