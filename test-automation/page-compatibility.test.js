...
assert.match(baoCao, /report\.js\?v=20260910-payroll-history-v1/);
...
assert.match(serviceWorker, /tdt-chamcong-v167-payroll-history-20260910/);
assert.match(serviceWorker, /subject-rate-policy\.js\?v=20260809-subject-rate-v1/);
assert.match(serviceWorker, /report\.js\?v=20260910-payroll-history-v1/);
