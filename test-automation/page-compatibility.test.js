...
assert.match(baoCao, /db-service\.js\?v=20260910-payroll-rate-persistence-v1/);
...
assert.match(serviceWorker, /db-service\.js\?v=20260910-payroll-rate-persistence-v1/);
