...
assert.match(baoCao, /db-service\.js\?v=20260908-incident-recovery-v1/);
...
assert.match(serviceWorker, /tdt-chamcong-v156-incident-recovery-20260908/);
...
assert.match(chamCong, /db-service\.js\?v=20260908-incident-recovery-v1/);
assert.match(chamCong, /main\.js\?v=20260908-incident-recovery-v1/);
assert.match(chamCong, /timekeeping\.js\?v=20260908-incident-recovery-v1/);
assert.match(serviceWorker, /db-service\.js\?v=20260908-incident-recovery-v1/);
