...
assert.match(baoCao, /db-service\.js\?v=20260923-remind8-v1/);
...
assert.match(chamCong, /db-service\.js\?v=20260923-remind8-v1/);
assert.match(chamCong, /main\.js\?v=20260923-remind8-v1/);
assert.match(chamCong, /timekeeping\.js\?v=20260919-resume-schedule-v1/);
assert.match(serviceWorker, /db-service\.js\?v=20260923-remind8-v1/);
