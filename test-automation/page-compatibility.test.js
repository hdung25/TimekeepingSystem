...
assert.match(baoCao, /db-service\.js\?v=20260923-fast-login-v2/);
assert.match(baoCao, /report\.js\?v=20260923-student-count-save-v1/);
...
assert.match(serviceWorker, /tdt-chamcong-v204-fast-login-20260923/);
assert.match(serviceWorker, /subject-rate-policy\.js\?v=20260809-subject-rate-v1/);
assert.match(serviceWorker, /report\.js\?v=20260923-student-count-save-v1/);
assert.match(serviceWorker, /lich-van-phong\.html/);
assert.match(chamCong, /db-service\.js\?v=20260923-fast-login-v2/);
assert.match(chamCong, /main\.js\?v=20260923-fast-login-v2/);
assert.match(chamCong, /timekeeping\.js\?v=20260919-resume-schedule-v1/);
assert.match(serviceWorker, /db-service\.js\?v=20260923-fast-login-v2/);
