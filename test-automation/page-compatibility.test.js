...
assert.match(baoCao, /report\.js\?v=20260923-web-push-v1/);
...
assert.match(serviceWorker, /tdt-chamcong-v199-web-push-20260923/);
assert.match(serviceWorker, /subject-rate-policy\.js\?v=20260809-subject-rate-v1/);
assert.match(serviceWorker, /report\.js\?v=20260923-web-push-v1/);
