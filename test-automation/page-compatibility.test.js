...
assert.match(baoCao, /db-service\.js\?v=20260919-review-v1/);
...
assert.match(serviceWorker, /tdt-chamcong-v189-salary-review-20260919/);
...
assert.match(chamCong, /db-service\.js\?v=20260919-review-v1/);
assert.match(chamCong, /main\.js\?v=20260919-review-v1/);
assert.match(chamCong, /timekeeping\.js\?v=20260918-payslip-status-sync-v1/);
assert.match(serviceWorker, /db-service\.js\?v=20260919-review-v1/);
