...
assert.match(baoCao, /report\.js\?v=20260908-feedback-repair-v1/);
...
assert.match(serviceWorker, /tdt-chamcong-v161-feedback-repair-20260908/);
assert.match(serviceWorker, /subject-rate-policy\.js\?v=20260809-subject-rate-v1/);
assert.match(serviceWorker, /report\.js\?v=20260908-feedback-repair-v1/);
