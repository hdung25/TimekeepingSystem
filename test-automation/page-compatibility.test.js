...
assert.match(baoCao, /report\.js\?v=20260922-payroll-list-v1/);
...
assert.match(serviceWorker, /tdt-chamcong-v200-payroll-list-20260922/);
assert.match(serviceWorker, /subject-rate-policy\.js\?v=20260809-subject-rate-v1/);
assert.match(serviceWorker, /report\.js\?v=20260922-payroll-list-v1/);
