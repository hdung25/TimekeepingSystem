...
assert.match(serviceWorker, /tdt-chamcong-v175-revoke-makeup-meeting-sync-20260911/);
...
assert.match(chamCong, /main\.js\?v=20260908-feedback-repair-v1/);
assert.match(chamCong, /timekeeping\.js\?v=20260908-incident-recovery-v1/);
assert.match(serviceWorker, /db-service\.js\?v=20260911-revoke-makeup-meeting-sync-v2/);
assert.match(serviceWorker, /timekeeping\.js\?v=20260908-incident-recovery-v1/);
