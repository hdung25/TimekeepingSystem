...
assert.match(baoCao, /db-service\.js\?v=20260911-revoke-makeup-meeting-sync-v2/);
assert.match(baoCao, /report\.js\?v=20260911-subject-refresh-meeting-auto-v1/);
assert.match(baoCao, /style\.css\?v=20260906-early10-recovery-v1/);
...
assert.match(serviceWorker, /tdt-chamcong-v177-subject-refresh-meeting-auto-20260911/);
assert.match(serviceWorker, /subject-rate-policy\.js\?v=20260809-subject-rate-v1/);
assert.match(serviceWorker, /report\.js\?v=20260911-subject-refresh-meeting-auto-v1/);
assert.match(serviceWorker, /lich-van-phong\.html/);
assert.match(chamCong, /db-service\.js\?v=20260911-revoke-makeup-meeting-sync-v2/);
assert.match(chamCong, /main\.js\?v=20260911-auto-checkout-resume-v1/);
assert.match(chamCong, /timekeeping\.js\?v=20260911-auto-checkout-resume-v1/);
assert.match(serviceWorker, /db-service\.js\?v=20260911-revoke-makeup-meeting-sync-v2/);
assert.match(serviceWorker, /timekeeping\.js\?v=20260911-auto-checkout-resume-v1/);
