...
assert.match(baoCao, /db-service\.js\?v=20260920-meeting-flow-v1/);
...
assert.match(chamCong, /db-service\.js\?v=20260920-meeting-flow-v1/);
...
assert.match(serviceWorker, /db-service\.js\?v=20260920-meeting-flow-v1/);
