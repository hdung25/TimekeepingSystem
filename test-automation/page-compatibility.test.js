...
assert.match(baoCao, /db-service\.js\?v=20260902-policy-payroll-absence-v1/);
assert.match(baoCao, /report\.js\?v=20260902-policy-payroll-absence-v1/);
assert.match(baoCao, /style\.css\?v=20260902-policy-payroll-absence-v1/);
...
assert.match(serviceWorker, /report\.js\?v=20260902-policy-payroll-absence-v1/);
assert.match(serviceWorker, /lich-van-phong\.html/);
assert.match(chamCong, /db-service\.js\?v=20260902-policy-payroll-absence-v1/);
assert.match(chamCong, /main\.js\?v=20260902-policy-payroll-absence-v1/);
assert.match(chamCong, /timekeeping\.js\?v=20260902-policy-payroll-absence-v1/);
assert.match(serviceWorker, /db-service\.js\?v=20260902-policy-payroll-absence-v1/);
assert.match(serviceWorker, /timekeeping\.js\?v=20260902-policy-payroll-absence-v1/);
