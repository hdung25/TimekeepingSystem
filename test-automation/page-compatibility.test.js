...
assert.match(baoCao, /report\.js\?v=20260809-cross-role-chain-v1/);
...
assert.match(serviceWorker, /tdt-chamcong-v113-cross-role-chain-20260809/);
assert.match(serviceWorker, /subject-rate-policy\.js\?v=20260809-subject-rate-v1/);
assert.match(serviceWorker, /20260809-cross-role-chain-v1/);
