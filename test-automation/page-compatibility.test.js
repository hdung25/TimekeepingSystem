...
assert.match(baoCao, /db-service\.js\?v=20260909-scheduled-overtime-v1/);
assert.match(baoCao, /report\.js\?v=20260909-scheduled-overtime-v1/);
...
assert.match(serviceWorker, /tdt-chamcong-v165-scheduled-overtime-20260909/);
assert.match(serviceWorker, /subject-rate-policy\.js\?v=20260809-subject-rate-v1/);
assert.match(serviceWorker, /report\.js\?v=20260909-scheduled-overtime-v1/);
assert.match(serviceWorker, /lich-van-phong\.html/);
assert.match(chamCong, /db-service\.js\?v=20260909-scheduled-overtime-v1/);
...
assert.match(serviceWorker, /db-service\.js\?v=20260909-scheduled-overtime-v1/);
