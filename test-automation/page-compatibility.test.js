...
assert.match(baoCao, /db-service\.js\?v=20260906-early10-recovery-v1/);
assert.match(baoCao, /report\.js\?v=20260906-early10-recovery-v1/);
...
assert.match(serviceWorker, /report\.js\?v=20260906-early10-recovery-v1/);
...
assert.match(serviceWorker, /db-service\.js\?v=20260906-early10-recovery-v1/);
