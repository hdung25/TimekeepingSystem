...
assert.match(baoCao, /db-service\.js\?v=20260911-early10-legacy-checkin-v1/);
...
assert.match(chamCong, /db-service\.js\?v=20260911-early10-legacy-checkin-v1/);
...
assert.match(serviceWorker, /db-service\.js\?v=20260911-early10-legacy-checkin-v1/);
