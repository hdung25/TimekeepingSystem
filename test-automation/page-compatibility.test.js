...
assert.match(baoCao, /db-service\.js\?v=20260921-meeting-edit-v1/);
assert.match(baoCao, /report\.js\?v=20260920-meeting-flow-v1/);
...
assert.match(serviceWorker, /tdt-chamcong-v192-meeting-edit-20260921/);
assert.match(serviceWorker, /subject-rate-policy\.js\?v=20260809-subject-rate-v1/);
assert.match(serviceWorker, /report\.js\?v=20260920-meeting-flow-v1/);
assert.match(serviceWorker, /lich-van-phong\.html/);
assert.match(chamCong, /db-service\.js\?v=20260921-meeting-edit-v1/);
assert.match(chamCong, /main\.js\?v=20260920-meeting-flow-v1/);
assert.match(chamCong, /timekeeping\.js\?v=20260919-resume-schedule-v1/);
assert.match(serviceWorker, /db-service\.js\?v=20260921-meeting-edit-v1/);
