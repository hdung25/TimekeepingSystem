...
assert.match(baoCao, /report\.js\?v=20260809-chip-policy-v2/);
...
assert.match(serviceWorker, /tdt-chamcong-v111-quang-huy-chip-fix-20260809/);
assert.match(serviceWorker, /subject-rate-policy\.js\?v=20260809-subject-rate-v1/);
assert.match(serviceWorker, /20260809-chip-policy-v2/);
