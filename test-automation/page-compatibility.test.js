...
assert.match(serviceWorker, /tdt-chamcong-v136-attendance-reliable-20260827/);
...
assert.match(chamCong, /db-service\.js\?v=20260827-attendance-reliable-v2/);
assert.match(chamCong, /main\.js\?v=20260827-attendance-reliable-v2/);
assert.match(chamCong, /timekeeping\.js\?v=20260827-attendance-reliable-v2/);
assert.match(serviceWorker, /db-service\.js\?v=20260827-attendance-reliable-v2/);
assert.match(serviceWorker, /timekeeping\.js\?v=20260827-attendance-reliable-v2/);
