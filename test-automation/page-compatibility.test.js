...
assert.match(baoCao, /db-service\.js\?v=20260905-attendance-integrity-v1/);
assert.match(baoCao, /report\.js\?v=20260905-attendance-integrity-v1/);
assert.match(baoCao, /style\.css\?v=20260905-attendance-integrity-v1/);
...
assert.match(serviceWorker, /tdt-chamcong-v151-attendance-integrity-20260905/);
assert.match(serviceWorker, /subject-rate-policy\.js\?v=20260809-subject-rate-v1/);
assert.match(serviceWorker, /report\.js\?v=20260905-attendance-integrity-v1/);
assert.match(serviceWorker, /lich-van-phong\.html/);
assert.match(chamCong, /db-service\.js\?v=20260905-attendance-integrity-v1/);
assert.match(chamCong, /main\.js\?v=20260905-attendance-integrity-v1/);
assert.match(chamCong, /timekeeping\.js\?v=20260905-attendance-integrity-v1/);
assert.match(serviceWorker, /db-service\.js\?v=20260905-attendance-integrity-v1/);
assert.match(serviceWorker, /timekeeping\.js\?v=20260905-attendance-integrity-v1/);
assert.match(serviceWorker, /schedule-attendance-admin\.js\?v=20260905-attendance-integrity-v1/);
