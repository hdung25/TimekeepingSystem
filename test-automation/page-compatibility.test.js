...
assert.match(baoCao, /db-service\.js\?v=20260906-quynh-autosubject-v1/);
...
assert.match(serviceWorker, /tdt-chamcong-v155-quynh-autosubject-20260906/);
...
assert.match(chamCong, /db-service\.js\?v=20260906-early10-recovery-v1/);
assert.match(chamCong, /main\.js\?v=20260906-early10-recovery-v1/);
assert.match(chamCong, /timekeeping\.js\?v=20260906-early10-recovery-v1/);
assert.match(serviceWorker, /db-service\.js\?v=20260906-quynh-autosubject-v1/);
assert.match(serviceWorker, /timekeeping\.js\?v=20260906-early10-recovery-v1/);
