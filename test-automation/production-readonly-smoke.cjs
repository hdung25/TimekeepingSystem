...
const serviceWorkerCacheName = 'tdt-chamcong-v195-delete-lock-hint-20260922';
const reportVersion = '20260921-meeting-review-v2';
const scheduleVersion = '20260922-delete-lock-hint-v1';
    ...
    try {
        ...
        await page.waitForFunction(async cacheName => {
            ...
            return !!(await cache.match('/js/main.js?v=20260921-meeting-review-v2')) &&
                ...
                !!(await cache.match('/js/schedule.js?v=20260922-delete-lock-hint-v1'));
