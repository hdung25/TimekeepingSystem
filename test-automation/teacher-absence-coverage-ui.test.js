...
assert.match(worker, /schedule\.js\?v=20260905-attendance-integrity-v1/);
assert.match(worker, /teacher-shift-state\.js\?v=20260905-attendance-integrity-v1/);
assert.match(worker, /ui-service\.js\?v=20260905-attendance-integrity-v1/,
