...
assert.match(worker, /schedule\.js\?v=20260904-absence-coverage-actions-v1/);
assert.match(worker, /teacher-shift-state\.js\?v=20260904-absence-coverage-actions-v1/);
assert.match(worker, /ui-service\.js\?v=20260904-absence-coverage-actions-v1/,
